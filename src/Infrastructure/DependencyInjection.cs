...
public static class DependencyInjection
{
        ...
        IConfiguration configuration)
    {
        ...
        services.Configure<ServiceSettings>(configuration.GetSection(ServiceSettings.Key));
        ...
        services.AddSingleton(s => s.GetRequiredService<IOptions<ServiceSettings>>().Value);

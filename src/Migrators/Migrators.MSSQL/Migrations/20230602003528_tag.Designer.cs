...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.Image", b =>
                {
                    ...
                    b.Property<int>("DetectFaceStatus")
                        .HasColumnType("int");

                    b.Property<int>("DetectObjectStatus")
                        .HasColumnType("int");

                    b.Property<DateTime?>("FaceDetectLastUpdated")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("FaceRecognizeLastUpdated")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("ObjectDetectLastUpdated")
                        .HasColumnType("datetime2");

                    b.Property<int>("ProcessThumbStatus")
                        .HasColumnType("int");

                    b.Property<DateTime?>("RecentlyViewDatetime")
                        .HasColumnType("datetime2");

                    b.Property<int>("RecognizeFaceStatus")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.Sample", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.Tag", b =>
                {
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.Image", b =>
                {
                    ...
                    b.OwnsMany("CleanArchitecture.Blazor.Domain.Entities.FaceDetection", "FaceDetections", b1 =>
                        {
                    ...
                    b.OwnsOne("CleanArchitecture.Blazor.Domain.Entities.ImageMetaData", "MetaData", b1 =>
                        {
                            ...
                            b1.Property<DateTime?>("FaceDetectLastUpdated")
                                .HasColumnType("datetime2");

                            b1.Property<DateTime?>("FaceRecognizeLastUpdated")
                                .HasColumnType("datetime2");
                            ...
                            b1.Property<DateTime?>("ObjectDetectLastUpdated")
                                .HasColumnType("datetime2");
                    ...
                    b.OwnsMany("CleanArchitecture.Blazor.Domain.Entities.ThumbImage", "ThumbImages", b1 =>
                        {
                            b1.Property<int>("ImageId")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.Sample", b =>
                {
                    b.OwnsMany("CleanArchitecture.Blazor.Domain.Entities.SampleImage", "SampleImages", b1 =>
                        {
                            ...
                            b1.HasKey("SampleId", "Id");

                            b1.ToTable("Samples");

                            b1.ToJson("SampleImages");
            ...
            modelBuilder.Entity("ImageTag", b =>
                {
                    b.HasOne("CleanArchitecture.Blazor.Domain.Entities.Image", null)
                        .WithMany()
                        .HasForeignKey("ImagesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CleanArchitecture.Blazor.Domain.Entities.Tag", null)
                        .WithMany()
